<template>
	<view style="position: absolute;width: 100%;height: 100%;display: grid;background-image: url('https://s11.ax1x.com/2024/01/03/pijOXsx.jpg');
			...
			<van-nav-bar title="" left-text="返回" left-arrow @click-left="onClickLeft">
				<template #right>
					<view style="position: relative;width: max-content;color: #6389fa;">
						<span>挑战排行榜</span>
						<van-icon name="arrow" size="18" @click="onClickRight"
			...
			<view
				...
				<image v-if="personList[1]!=undefined" style="
					...
					border: 2px solid white;
						    "  mode="aspectFill" :src="personList[1].img"
				></image>
		...
		transition: transform 0.3s ease-in-out, box-shadow 0.3s ease-in-out;
			...
			<view
				...
				<view v-for="i,index in personList" :key="index"
					...
					class="items" v-if="personList.length!=0">
					<span style="white-space: nowrap;width: 35rpx;text-align: center;height: 80rpx;line-height: 80rpx;"
						class="items">{{i.place}}</span>
					<image
						style="height: 60rpx;width: 60rpx;border-radius: 100%;border: 2px solid black;position: relative;top: 0;bottom: 0;margin-top: auto;margin-bottom: auto;" mode="aspectFill" :src="i.img">
					</image>
					<span
					...
					<span class="items"
						style="height: 80rpx;line-height: 80rpx;width: 120rpx;text-align: center;">{{i.score}}分</span>
		...
		<view style="grid-row-start: 16;grid-row-end: 18;position: relative;" class="items">
			<view style="width: 95%; height: 98%;position: absolute;left: 0;right: 0;margin: auto;top: 0;bottom: 0;"
				class="item">
				<view
					style="position: absolute;background-color: #fbefda;width: 100%;height: 100rpx;transform: translateY(-13rpx);  border-radius: 50rpx;">
				</view>
				<view
					...
					<view style="height: 60rpx;width: 60rpx;border-radius: 100%;border: 2px solid black;position: relative;top: 0;bottom: 0;margin-top: auto;
						margin-bottom: auto;background-repeat: no-repeat;
						background-size: cover;" :style="{backgroundImage: 'url('+userInformation.img+')'}">
					</view>
					<span
						style="width: 300rpx;height: max-content;position: relative;top: 0;bottom: 0;margin: auto;margin-left: 0;margin-right: 0;"
